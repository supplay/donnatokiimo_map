...
import { createUserPoint } from "../graphql/mutations";
const client = generateClient();
export default function UserPointCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createUserPoint.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "UserPointCreateForm")}
      {...rest}
    >
      <TextField
        label="Points"
